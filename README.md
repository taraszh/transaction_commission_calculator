...
The **CommissionCalculator** project is responsible for processing transaction data, calculating commissions, and handling exchange rates. This service reads transactions from a file, processes each transaction to calculate the appropriate commission, and handles any exceptions that may occur during the process.
